...
class _ProviderAccountPageState extends State<ProviderAccountPage> {
  ...
  Widget _buildPersonalInfo(String uid, Map<String, dynamic> data) {
    ...
    String locationDisplay = 'Not set';
    if (latitude != null && longitude != null && (latitude != 0 || longitude != 0)) {
      locationDisplay = 'Lat: ${latitude.toStringAsFixed(6)}, Lng: ${longitude.toStringAsFixed(6)}';
    }
                ...
                children: [
                  ...
                  if (latitude != null && longitude != null)
                    Padding(
                      ...
                      child: Text(
                        'Last updated: ${data['last_location_update'] != null ? _formatTimestamp(data['last_location_update']) : 'Unknown'}',
                        style: TextStyle(
                          fontSize: 11,
        ...
        actions: [
          ...
          ElevatedButton.icon(
            ...
            onPressed: () async {
              ...
              try {
                // Update Firestore with GPS coordinates
                await _db.collection('providers').doc(uid).update({
                  'latitude': position.latitude,
                  'longitude': position.longitude,
                  'location': 'GPS Location (${position.latitude.toStringAsFixed(4)}, ${position.longitude.toStringAsFixed(4)})',
